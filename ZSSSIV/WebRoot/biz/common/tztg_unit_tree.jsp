...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path%>/flexgrid/flexigrid.js"></script>
  	...
  	function _btnSubmit(){
  		parent.setUnitName(getSelectNode().name);
  		parent.setUnitID(getSelectNode().xzqh);
  		window.close();
  	}
  	</script>
  </head>
  				...
  				<table cellpadding="0" cellspacing="0" border="1px" width="100%">
					<tr height="23px">
						<td class="rtitletdM" valign="bottom" align="left">
							<span style="color: #B96F26; font-weight: bolder;">单位选择树</span>
						</td>
					</tr>
				</table>
  ...
  <script type="text/javascript" src="<%=path%>/biz/common/tztg_unit_tree.js"></script>
</html>
