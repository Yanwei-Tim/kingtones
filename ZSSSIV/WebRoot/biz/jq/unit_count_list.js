...
//----------------【定义flexgrid开始】--------------------------------------------------------------------------
	...
	var stime=null;
	 ...
	 $("#flex1").flexigrid(
	{
		url: webroot+'/jq/psUnitCAC!findJqUnitCount.action',
		dataType: 'json',
		colModel : [
            {display: 'ID', name : 'id', width : 20, sortable : true, align: 'center',hide: true},
			{display: '单位名称', name : 'name', width : 110, sortable : true, align: 'left'},
			{display: '受理警情次数', name : 'accept', width : 90, sortable : false, align: 'left'},
			{display: '处警到位次数', name : 'reach', width : 90, sortable : false, align: 'left'},
			{display: '处警完成次数', name : 'finish', width : 90, sortable : false, align: 'left'},
			{display: '统计起始日期', name : 'stime', width : 160, sortable : false, align: 'left'},
			{display: '统计结束日期', name : 'etime', width : 260, sortable : false, align: 'left'}
			],
//		buttons : [
