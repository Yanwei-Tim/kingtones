 ...
 */
package com.kingtone.androidpn.server.xmpp.handler;
...
import com.kingtone.androidpn.server.bs.UserExistsException;
import com.kingtone.androidpn.server.bs.UserNotFoundException;
import com.kingtone.androidpn.server.bs.UserPNBS;
import com.kingtone.androidpn.server.xmpp.UnauthorizedException;
...
public class IQRegisterHandler extends IQHandler {
    ...
    public IQRegisterHandler() {
    	userPNBS = ServiceLocator.getUserService();
        ...
        if (IQ.Type.get.equals(packet.getType())) {
            ...
            try {
                ...
                if (query.element("remove") != null) {
                    ...
                    User user;
                    if (session.getStatus() == Session.STATUS_AUTHENTICATED) {
                        user = userPNBS.findUserByUsername(session.getUsername());
                    } else {
                        user = new User();
                    }
