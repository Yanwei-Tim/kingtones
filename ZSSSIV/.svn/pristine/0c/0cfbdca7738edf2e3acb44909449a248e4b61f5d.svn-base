...
<html>
  ...
  <body>
  	<table width="100%">
  		<tr height="5%">
  			<td><span style="color:#000000; font-weight:bolder;">管理功能&gt;&gt;通讯录管理</span></td>
  		</tr>
  		<tr height="95%" >
  			<%--<td width="15%">
  				...
  				<table cellpadding="0" cellspacing="0" width="800px">
					<tr height="23px">
						<td class="rtitletdM"  align="left">
							<span style="color: #000000; font-weight: bolder;">通讯录列表</span>
						</td>
					</tr>
				</table>
...
<script type="text/javascript" src="<%=path%>/biz/manage/address/address_mgr_list.js"></script>
  </body>
</html>
