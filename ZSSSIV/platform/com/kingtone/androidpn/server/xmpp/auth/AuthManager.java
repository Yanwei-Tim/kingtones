 ...
 */
package com.kingtone.androidpn.server.xmpp.auth;
...
import com.kingtone.androidpn.server.bs.ServiceLocator;
...
import com.kingtone.androidpn.server.xmpp.UnauthenticatedException;
import com.kingtone.androidpn.server.xmpp.XmppServer;
...
public class AuthManager {
    ...
    public static String getPassword(String username)
    	...
    	String pass ="";
    	UserPNBS uuu = ServiceLocator.getUserService();
    	User us = uuu.findUserByUsername(username);
    	if(us!=null){
    		pass = us.getPassword();
    	}
        return pass;
...
//            System.out.println("--digest---"+digest+"---anticipatedDigest---"+anticipatedDigest);
