...
String buttons = request.getSession().getAttribute("ROLE_BUTTON").toString();
%>
<html xmlns="http://www.w3.org/1999/xhtml">
	<head id="Head1">
     ...
     <!--
//    function showhidePic(obj)
//    {
//        if(parent.topset.rows!='27,*')
//        {
//            parent.topset.rows='27,*';
//            window.scroll(0,102)
//            obj.src="images/top/bar_011.gif";
//            obj.title="点击这里显示顶部";
//        }
//        else
//        {
//            parent.topset.rows='102,*';
//            obj.src="images/top/bar_07.gif";
//            obj.title="点击这里隐藏顶部";
//        }
//    }-->
...
function setCookie(value, seconds) {   
 ...
 document.cookie = "ROLE_BUTTON="+value+"; path=/";   //转码并赋值   
} 
...
{   var pStr="Police_UserID";
	...
	<body onload="SetSessionID('<%=buttons %>')">
									...
									<table width="217px" height="31" border="0" cellpadding="0"
										...
										<tr>
											...
											<td>
												...
												%><!-- %=request.getSession().getAttribute("LOGIN_USERNAME")%--></span> </b>』
											</td>
										</tr>
									</table>
								</td>
										...
										<tr>
											...
											<td>
												<table height="31" border="0" cellpadding="0"
													...
													<tr>
														<td>
															<a href="javascript:history.go(-1)" target="right">后退</a>
														</td>
													</tr>
												</table>
											</td>
											<td>
												<table height="31" border="0" cellpadding="0"
													...
													<tr>
														<td>
															<a href="javascript:history.go(+1)" target="right">前进</a>
														</td>
													</tr>
												</table>
											</td>
											<td>
												<table height="31" border="0" cellpadding="0"
													...
													<tr>
														<td>
															<a href="#"
																onclick="if (!window.confirm('您确认要切换用户吗？')){return false;}else{parent.window.location.href='<%=path%>/j_acegi_logout';}">切换用户</a>
														</td>
													</tr>
												</table>
											</td>
													...
													<tr>
														<td>
															<img src="<%=path%>/platform/images/top/bar_07.gif" width="16" height="16"
																onclick="if(window.parent.document.getElementsByTagName('frameset')[0].rows!='27,*'){window.parent.document.getElementsByTagName('frameset')[0].rows='27,*';window.scroll(0,102);this.src='<%=path%>/platform/images/top/bar_011.gif';}else{window.parent.document.getElementsByTagName('frameset')[0].rows='102,*';;this.src='<%=path%>/platform/images/top/bar_07.gif';};"
