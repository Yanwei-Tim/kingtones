/**
 * BasicHttpBinding_TaskServiceStub.java
 *
...
public class BasicHttpBinding_TaskServiceStub extends org.apache.axis.client.Stub implements com.kingtone.jw.service.jwoa.wcf.TaskService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tempuri.org/", "GetDBListServiceResult"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        param.setNillable(true);
        oper.addParameter(param);
        ...
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tempuri.org/", "GetCYListServiceResult"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tempuri.org/", "recordCount"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"), java.lang.Integer.class, false, false);
    ...
    public BasicHttpBinding_TaskServiceStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public BasicHttpBinding_TaskServiceStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public BasicHttpBinding_TaskServiceStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public void getDBListService(java.lang.Integer pageSize, java.lang.Integer pageIndex, java.lang.String userName, java.lang.String corpId, javax.xml.rpc.holders.StringHolder getDBListServiceResult, javax.xml.rpc.holders.IntegerWrapperHolder recordCount) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://tempuri.org/TaskService/GetDBListService");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "GetDBListService"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {pageSize, pageIndex, userName, corpId});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                getDBListServiceResult.value = (java.lang.String) _output.get(new javax.xml.namespace.QName("http://tempuri.org/", "GetDBListServiceResult"));
            } catch (java.lang.Exception _exception) {
                getDBListServiceResult.value = (java.lang.String) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("http://tempuri.org/", "GetDBListServiceResult")), java.lang.String.class);
            }
            try {
  ...
  throw axisFaultException;
    ...
    public void getCYListService(java.lang.Integer pageSize, java.lang.Integer pageIndex, java.lang.String userName, java.lang.String corpId, javax.xml.rpc.holders.StringHolder getCYListServiceResult, javax.xml.rpc.holders.IntegerWrapperHolder recordCount) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://tempuri.org/TaskService/GetCYListService");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "GetCYListService"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {pageSize, pageIndex, userName, corpId});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            _output = _call.getOutputParams();
            try {
                getCYListServiceResult.value = (java.lang.String) _output.get(new javax.xml.namespace.QName("http://tempuri.org/", "GetCYListServiceResult"));
            } catch (java.lang.Exception _exception) {
                getCYListServiceResult.value = (java.lang.String) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("http://tempuri.org/", "GetCYListServiceResult")), java.lang.String.class);
            }
            try {
                recordCount.value = (java.lang.Integer) _output.get(new javax.xml.namespace.QName("http://tempuri.org/", "recordCount"));
            } catch (java.lang.Exception _exception) {
