...
String op_time = (String)request.getParameter("op_time");



String postData="jwLog.biz_id="+biz_id+"&jwLog.days="+op_time;
%> 
	...
	$("#flex1").flexigrid(
	{  
		url: webroot+'/xajw/jwLogAC!tongJiJwLogNuser.action?'+postData,
		dataType: 'json',
		colModel : [
			...
			{display: '未登录模块', name : 'bizname', width : 150, align: 'center',hide:false},
			{display: '未使用天数', name : 'days', width : 150, align: 'center',hide:false}
