...
public class AlarmEvent  extends Applet{ 
 ...
 public AlarmEvent(String value) {
	 sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	 feaMap = new HashMap<String, String>(); 
	 feaMap.put("name", "移动警务预警通知");
	 feaMap.put("release", sdf.format(new Date()));
	 feaMap.put("feature", value);
	  init();   
	  handle();
...
//
//		Player player;
//		File playFile=new File(Filename);//你的MP3文件
//		 try {
...
//}
	 ...
	 public static void main(String args[]) {
	  ...
	  AlarmEvent tt = new AlarmEvent("逃犯");
//	  tt.play("D:/news.wav");
	 }
