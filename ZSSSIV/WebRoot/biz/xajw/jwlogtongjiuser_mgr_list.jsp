...
String postData="jwLog.biz_id="+biz_id+"&jwLog.op_time1="+op_time1+"&jwLog.op_time2="+op_time2+"&jwLog.user_id="+user_id;
%> 
	...
	$("#flex1").flexigrid(
	{  
		url: webroot+'/xajw/jwLogAC!tongJiJwLogUser.action?'+postData,
		dataType: 'json',
		colModel : [
			...
			{display: '登录时间', name : 'op_time1', width : 150, align: 'center',hide:false}
