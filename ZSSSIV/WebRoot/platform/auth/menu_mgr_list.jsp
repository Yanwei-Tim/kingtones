...
<html>
  <head>
	...
	<link rel="stylesheet" href="<%=path%>/ztree/demo/demoStyle/demo.css" type="text/css"/>
  	...
  	<script type="text/javascript" src="<%=path%>/ztree/demo/asyncData/demoData.js"></script>
  ...
  <body>
  	<table width="100%">
  		<tr height="5%">
  			<td><span style="color:#000000; font-weight:bolder;">菜单管理&gt;&gt;菜单管理</span></td>
  		</tr>
  		<tr height="95%" >
  			<td width="15%">
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr height="16px">
						<td class="rtitletdM" valign="bottom" align="left">
							<span style="color:#000000; font-weight: bolder;">一级菜单选择</span>
						</td>
					</tr>
				</table>
  				...
  				<table cellpadding="0" cellspacing="0" width="800px">
					<tr height="23px">
						<td class="rtitletdM"  align="left">
							<span style="color:#000000; font-weight: bolder;">二级菜单列表</span>
						</td>
					</tr>
				</table>
...
<script type="text/javascript" src="<%=path%>/platform/auth/menu_mgr_list.js"></script>
  </body>
</html>
