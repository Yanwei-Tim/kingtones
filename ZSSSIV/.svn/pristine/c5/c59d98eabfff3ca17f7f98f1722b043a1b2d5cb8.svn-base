...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  <body>
  	<table width="100%">
  		<tr height="5%">
  			<td><span style="font-weight:bolder;">西安警务&gt;&gt;警务GPS数据查询</span></td>
  		</tr>
  		<tr height="95%" >
  			<td>
  				<table width="850px">
  					<tr height="23px">
						<td class="rtitletdM" valign="bottom" align="left">
							<span style="font-weight: bolder;">警务GPS数据</span>
						</td>
					</tr>
				</table>
					...
					<tr height="23px">
						...
						<form id="form2">
							...
							<table >
							  	<tr>
							  		<td>姓名:</td>
							  		<td><input id="userName"  type="text"  name="jwGpsData.userName" size="10px"/></td>
							  		<td>&nbsp;设备串码:</td>
							  		<td><input id="deviceid"  type="text"  name="jwGpsData.deviceid" size="10px"/></td>
							  		<td>&nbsp;日期段:</td>
							  		<td><div><input id="startdate"  type="text"  name="jwGpsData.startdate" size="10px" onClick="SelectDate(this,'yyyy-MM-dd',0,0)" readonly/></div></td>
							  		<td>-</td>
							  		<td><div><input id="enddate"  type="text"  name="jwGpsData.enddate" size="10px"  onClick="SelectDate(this,'yyyy-MM-dd',0,0)" readonly/></div></td>
							  		<td><input type="button" id="btn1"  value="查 询" onclick="searchGPSData(this)"/></td>
							  	</tr>
						  	</table>
						  	</form>
						</td>
...
<script type="text/javascript" src="<%=path%>/biz/xajw/jwgps_search_list.js"></script>
  </body>
</html>
