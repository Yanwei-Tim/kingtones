  		...
  		<tr height="100%" >
  			<td width="15%">
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr >
	  					<td ><span style="color:#000000; font-weight:bolder;">警情管理&gt;&gt;人员处警统计</span></td>
	  				</tr>
					<tr height="23px">
  			...
  			<td >
				<table cellpadding="0" cellspacing="0" width="800px">
					<tr height="25px" >
						<td class="rtitletdM" valign="bottom" align="left">
							<span style="color: #000000; font-weight: bolder;">统计人员列表</span>
						</td>
					</tr>
					<tr height="23px">
...
<script type="text/javascript" src="<%=path%>/biz/jq/user_count_list.js"></script>
