...
<script type="text/javascript">
 $(document).ready(function(){
  ...
  <body>
  	<table width="100%">
  		<tr height="5%">
  			<td><span style="font-weight:bolder;">数据采集&gt;&gt;图片采集</span></td>
  		</tr>
  		<tr height="95%" >
  			<td width="15%">
  			...
  			<td>
  				<table width="850px">
  					<tr height="23px">
						<td class="rtitletdM" valign="bottom" align="left">
							<span style="font-weight: bolder;">图片列表</span>
						</td>
					</tr>
				</table>
...
<script type="text/javascript" src="<%=path%>/biz/common/tpcj_mgr_list.js"></script>
  </body>
</html>
