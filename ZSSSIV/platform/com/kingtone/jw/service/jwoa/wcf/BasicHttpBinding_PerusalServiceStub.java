/**
 * BasicHttpBinding_PerusalServiceStub.java
 *
...
public class BasicHttpBinding_PerusalServiceStub extends org.apache.axis.client.Stub implements com.kingtone.jw.service.jwoa.wcf.PerusalService_PortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("GetReadInTurnListService");
        ...
        param.setNillable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tempuri.org/", "GetReadInTurnListServiceResult"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        param.setNillable(true);
        oper.addParameter(param);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("GetReadInTurnDetailService");
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("http://tempuri.org/", "GetReadInTurnDetailServiceResult"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[1] = oper;

        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("SetReadStatusService");
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tempuri.org/", "guid"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), java.lang.String.class, false, false);
        param.setOmittable(true);
        param.setNillable(true);
        oper.addParameter(param);
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        oper.setReturnClass(java.lang.String.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://tempuri.org/", "SetReadStatusServiceResult"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[2] = oper;
    ...
    public BasicHttpBinding_PerusalServiceStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public BasicHttpBinding_PerusalServiceStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public BasicHttpBinding_PerusalServiceStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public void getReadInTurnListService(java.lang.String queryParamsXml, java.lang.Integer pageSize, java.lang.Integer pageIndex, java.lang.String userName, java.lang.String corpId, javax.xml.rpc.holders.StringHolder getReadInTurnListServiceResult, javax.xml.rpc.holders.IntegerWrapperHolder recordCount) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://tempuri.org/PerusalService/GetReadInTurnListService");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "GetReadInTurnListService"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {queryParamsXml, pageSize, pageIndex, userName, corpId});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                getReadInTurnListServiceResult.value = (java.lang.String) _output.get(new javax.xml.namespace.QName("http://tempuri.org/", "GetReadInTurnListServiceResult"));
            } catch (java.lang.Exception _exception) {
                getReadInTurnListServiceResult.value = (java.lang.String) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("http://tempuri.org/", "GetReadInTurnListServiceResult")), java.lang.String.class);
            }
            try {
  ...
  throw axisFaultException;
    ...
    public java.lang.String getReadInTurnDetailService(java.lang.String guid, java.lang.String userName, java.lang.String corpId) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://tempuri.org/PerusalService/GetReadInTurnDetailService");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "GetReadInTurnDetailService"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {guid, userName, corpId});
  ...
  throw axisFaultException;
    ...
    public java.lang.String setReadStatusService(java.lang.String guid, java.lang.String userName, java.lang.String corpId) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://tempuri.org/PerusalService/SetReadStatusService");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "SetReadStatusService"));
